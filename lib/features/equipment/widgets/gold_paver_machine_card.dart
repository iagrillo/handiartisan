...
class GoldPaverMachineCard extends StatelessWidget {
  final VoidCallback onTap;
  const GoldPaverMachineCard({Key? key, required this.onTap}) : super(key: key);
          ...
          children: [
            ClipRRect(
              ...
              child: SafeAssetImage(
                assetPath: 'assets/paver_machine.png',
                width: 40,
                height: 40,
                fit: BoxFit.cover,
              ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('High-performance paver machine for road construction.',
