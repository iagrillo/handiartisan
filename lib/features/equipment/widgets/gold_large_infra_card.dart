...
class GoldLargeInfraCard extends StatelessWidget {
  final VoidCallback onTap;
  const GoldLargeInfraCard({Key? key, required this.onTap}) : super(key: key);
          ...
          children: [
            ClipRRect(
              ...
              child: SafeAssetImage(
                assetPath: 'assets/large_infra.png',
                width: 40,
                height: 40,
                fit: BoxFit.cover,
              ),
