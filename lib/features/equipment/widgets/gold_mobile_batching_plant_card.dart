...
class GoldMobileBatchingPlantCard extends StatelessWidget {
  final VoidCallback onTap;
  const GoldMobileBatchingPlantCard({Key? key, required this.onTap}) : super(key: key);
          ...
          children: [
            ClipRRect(
              ...
              child: SafeAssetImage(
                assetPath: 'assets/mobile_batching_plant.png',
                width: 40,
                height: 40,
                fit: BoxFit.cover,
              ),
