...
class GoldToraBatchingPlantCard extends StatelessWidget {
  final VoidCallback onTap;
  const GoldToraBatchingPlantCard({Key? key, required this.onTap}) : super(key: key);
          ...
          children: [
            ClipRRect(
              ...
              child: SafeAssetImage(
                assetPath: 'assets/tora_batching_plant.png',
                width: 40,
                height: 40,
                fit: BoxFit.cover,
              ),
